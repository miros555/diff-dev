...
class KmndPluginActive{
   static protected $pluginListRequired = [
                ...
                [    
                    'path' => 'clearfy-pro/clearfy-pro.php', 
                    'name' => 'Clearfy Pro',
                ],
                [
   ...
   static private function getPluginActive($pluginList){
        ...
        foreach ($r as $item){
            ...
            if (!is_plugin_active($item['path'])){
                $str .= '<p>'. __( "Plugin not installed or not activated.", "Komanda" ) . ' <b>' . $install_link .'<b></p>';
            }
        }
        return $str;
    }
        ...
        add_action( 'admin_notices', function() {
            ...
            if($str_error != '') {
                ...
                <div class="notice notice-error is-dismissible">
                    <?php echo $str_error;?>
                    <a href="/wp-admin/plugins.php" target="_blank"><?php _e('go to the plugins page','Komanda');?> -></a>
                </div>
                <?php
            }
